...
FILE_INFO = {
    ...
    # system/ (missing)
    'system/protocols.itr': ('Object Message Protocols', 'Detailed description of the object message protocol between C64 client and host.'),

    # admin/survey/ — Pre-test responses (before extended beta)
    'admin/survey/q01.pre': ('Survey Q1 Pre: Overall Rating', 'Pre-test responses: overall rating of Habitat (Poor to Excellent).'),
    'admin/survey/q02.pre': ('Survey Q2 Pre: UI Rating', 'Pre-test responses: rating the user interface and mechanics (Very easy to Very difficult).'),
    'admin/survey/q03.pre': ('Survey Q3 Pre: Fun Rating', 'Pre-test responses: how fun is playing Habitat (No fun at all to A lot of fun).'),
    'admin/survey/q04.pre': ('Survey Q4 Pre: Best Features', 'Pre-test responses: what players like most about Habitat.'),
    'admin/survey/q05.pre': ('Survey Q5 Pre: Worst Features', 'Pre-test responses: what players dislike most about Habitat.'),
    'admin/survey/q06.pre': ('Survey Q6 Pre: One Change', 'Pre-test responses: if you could add, change, or delete one aspect of Habitat.'),
    'admin/survey/q07.pre': ('Survey Q7 Pre: Features to Add', 'Pre-test responses: what features or activities to add.'),
    'admin/survey/q08.pre': ('Survey Q8 Pre: Features to Remove', 'Pre-test responses: what features or activities to change or delete.'),
    'admin/survey/q09.pre': ('Survey Q9 Pre: Disk Loads', 'Pre-test responses: opinion on disk loading times.'),
    'admin/survey/q10.pre': ('Survey Q10 Pre: Activities Tried', 'Pre-test responses: which structured activities or adventures players participated in.'),
    'admin/survey/q11.pre': ('Survey Q11 Pre: Activity Ratings', 'Pre-test responses: rating each structured activity or adventure.'),
    'admin/survey/q12.pre': ('Survey Q12 Pre: Activity Frequency', 'Pre-test responses: how often members would participate in structured activities.'),
    'admin/survey/q13.pre': ('Survey Q13 Pre: Activity Duration', 'Pre-test responses: preferred duration for structured activities.'),
    'admin/survey/q14.pre': ('Survey Q14 Pre: Create Activities', 'Pre-test responses: would players want to create activities for others.'),
    'admin/survey/q15.pre': ('Survey Q15 Pre: Design Regions', 'Pre-test responses: would players want to design and create regions.'),
    'admin/survey/q16.pre': ('Survey Q16 Pre: Price Sensitivity', 'Pre-test responses: expected play hours at 8 cents per minute.'),
    'admin/survey/q17.pre': ('Survey Q17 Pre: Adoption Estimate', 'Pre-test responses: what percentage of Q-Link members would become regular players.'),
    'admin/survey/q18.pre': ('Survey Q18 Pre: Willingness to Pay', 'Pre-test responses: how much players would pay for Habitat vs. retail C64 games.'),
    'admin/survey/q19.pre': ('Survey Q19 Pre: Last Played', 'Pre-test responses: when players last played Habitat.'),
    'admin/survey/q20.pre': ('Survey Q20 Pre: Why Still Playing', 'Pre-test responses: why active players continue to play and help test.'),
    'admin/survey/q21.pre': ('Survey Q21 Pre: Why Stopped', 'Pre-test responses: why inactive players stopped and what would bring them back.'),
    'admin/survey/q22.pre': ('Survey Q22 Pre: Rating at Scale', 'Pre-test responses: projected rating assuming 100+ avatars and more activities.'),
    'admin/survey/q23.pre': ('Survey Q23 Pre: Hours Played', 'Pre-test responses: hours spent in Habitat since receiving disk version 6.4.'),
    'admin/survey/q24.pre': ('Survey Q24 Pre: Age', 'Pre-test responses: player age demographics.'),
    'admin/survey/q25.pre': ('Survey Q25 Pre: Gender', 'Pre-test responses: player gender demographics.'),

    # admin/survey/ — Post-test responses (after extended beta)
    'admin/survey/q01.post': ('Survey Q1 Post: Overall Rating', 'Post-test responses: overall rating of Habitat after extended play.'),
    'admin/survey/q02.post': ('Survey Q2 Post: UI Rating', 'Post-test responses: rating the user interface after extended play.'),
    'admin/survey/q03.post': ('Survey Q3 Post: Fun Rating', 'Post-test responses: how fun is Habitat after extended play.'),
    'admin/survey/q04.post': ('Survey Q4 Post: Best Features', 'Post-test responses: what players like most after extended play.'),
    'admin/survey/q05.post': ('Survey Q5 Post: Worst Features', 'Post-test responses: what players dislike most after extended play.'),
    'admin/survey/q06.post': ('Survey Q6 Post: One Change', 'Post-test responses: one thing to add, change, or delete after extended play.'),
    'admin/survey/q07.post': ('Survey Q7 Post: Features to Add', 'Post-test responses: features or activities to add after extended play.'),
    'admin/survey/q08.post': ('Survey Q8 Post: Features to Remove', 'Post-test responses: features to change or delete after extended play.'),
    'admin/survey/q09.post': ('Survey Q9 Post: Disk Loads', 'Post-test responses: opinion on disk loading times after extended play.'),
    'admin/survey/q10.post': ('Survey Q10 Post: Activities Tried', 'Post-test responses: which activities players participated in after extended play.'),
    'admin/survey/q11.post': ('Survey Q11 Post: Activity Ratings', 'Post-test responses: rating each activity after extended play.'),
    'admin/survey/q12.post': ('Survey Q12 Post: Activity Frequency', 'Post-test responses: expected activity participation frequency after extended play.'),
    'admin/survey/q13.post': ('Survey Q13 Post: Activity Duration', 'Post-test responses: preferred activity duration after extended play.'),
    'admin/survey/q14.post': ('Survey Q14 Post: Create Activities', 'Post-test responses: interest in creating activities after extended play.'),
    'admin/survey/q15.post': ('Survey Q15 Post: Design Regions', 'Post-test responses: interest in designing regions after extended play.'),
    'admin/survey/q16.post': ('Survey Q16 Post: Price Sensitivity', 'Post-test responses: expected play hours at 8 cents/minute after extended play.'),
    'admin/survey/q17.post': ('Survey Q17 Post: Adoption Estimate', 'Post-test responses: projected member adoption rate after extended play.'),
    'admin/survey/q18.post': ('Survey Q18 Post: Willingness to Pay', 'Post-test responses: willingness to pay after extended play.'),
    'admin/survey/q19.post': ('Survey Q19 Post: Last Played', 'Post-test responses: when players last played after extended beta.'),
    'admin/survey/q20.post': ('Survey Q20 Post: Why Still Playing', 'Post-test responses: why players continue after extended play.'),
    'admin/survey/q21.post': ('Survey Q21 Post: Why Stopped', 'Post-test responses: why players stopped after extended play.'),
    'admin/survey/q22.post': ('Survey Q22 Post: Rating at Scale', 'Post-test responses: projected rating at scale after extended play.'),
    'admin/survey/q23.post': ('Survey Q23 Post: Hours Played', 'Post-test responses: hours played after extended beta period.'),
    'admin/survey/q24.post': ('Survey Q24 Post: Age', 'Post-test responses: player age demographics after extended play.'),
    'admin/survey/q25.post': ('Survey Q25 Post: Gender', 'Post-test responses: player gender demographics after extended play.'),
    'admin/survey/summary': ('Survey Results Summary', 'Compiled pre-test vs post-test results with tabulated statistics and player comments for all 25 questions.'),

    # hotlist/ — Daily task snapshots, Nov 1986 – Apr 1987
    'hotlist/hotlist.11.03.86.tbl': ('Hot List Nov 3, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.04.86.tbl': ('Hot List Nov 4, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.06.86.tbl': ('Hot List Nov 5, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.07.86.tbl': ('Hot List Nov 7, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.11.86.tbl': ('Hot List Nov 11, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.12.86.tbl': ('Hot List Nov 12, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.13.86.tbl': ('Hot List Nov 13, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.14.86.tbl': ('Hot List Nov 14, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.17.86.tbl': ('Hot List Nov 15, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.19.86.tbl': ('Hot List Nov 19, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.24.86.tbl': ('Hot List Nov 24, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.11.25.86.tbl': ('Hot List Nov 25, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.12.02.86.tbl': ('Hot List Dec 2, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.12.08.86.tbl': ('Hot List Dec 8, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.12.09.86.tbl': ('Hot List Dec 9, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.12.12.86.tbl': ('Hot List Dec 12, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.12.19.86.tbl': ('Hot List Dec 19, 1986', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.12.tbl': ('Hot List Jan 12, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.14.tbl': ('Hot List Jan 14, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.15.tbl': ('Hot List Jan 15, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.16.tbl': ('Hot List Jan 16, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.19.tbl': ('Hot List Jan 19, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.20.tbl': ('Hot List Jan 20, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.23.tbl': ('Hot List Jan 23, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.26.tbl': ('Hot List Jan 26, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.27.tbl': ('Hot List Jan 27, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.01.29.tbl': ('Hot List Jan 29, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.02.tbl': ('Hot List Feb 2, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.05.tbl': ('Hot List Feb 5, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.06.tbl': ('Hot List Feb 6, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.09.tbl': ('Hot List Feb 9, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.11.tbl': ('Hot List Feb 11, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.17.tbl': ('Hot List Feb 17, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.19.tbl': ('Hot List Feb 19, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.02.26.tbl': ('Hot List Feb 26, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.02.tbl': ('Hot List Mar 2, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.06.tbl': ('Hot List Mar 6, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.13.tbl': ('Hot List Mar 13, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.17.tbl': ('Hot List Mar 17, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.20.tbl': ('Hot List Mar 20, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.24.tbl': ('Hot List Mar 24, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.25.tbl': ('Hot List Mar 25, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.03.26.tbl': ('Hot List Mar 26, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.04.07.tbl': ('Hot List Apr 7, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.04.08.tbl': ('Hot List Apr 8, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
    'hotlist/hotlist.04.09.tbl': ('Hot List Apr 9, 1987', 'Daily task priority snapshot. Tracks bugs, features, and action items for the Habitat team.'),
}
